...
//                holder.task_time.setText(Html.fromHtml("<strike>" + singleTask.get("time_at") + "</strike>"));
                holder.checkBtn.setChecked(true);
            } else {
                holder.task_name.setText(singleTask.get("task"));
//                holder.task_time.setText(singleTask.get("time_at"));
...
//                        tmpHolder.task_time.setText(Html.fromHtml("<strike>" + singleTask.get("time_at") + "</strike>"));
                    } else {
                        database.updateTaskStatus(singleTask.get("id"), 0);
                        tmpHolder.task_name.setText(singleTask.get("task"));
//                        tmpHolder.task_time.setText(singleTask.get("time_at"));
                    }
