...
public class AdminCatagoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogoutBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(AdminCatagoryActivity.this, ECommerceActivity.class);
        ...
        CheckOrdersBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(AdminCatagoryActivity.this, AdminNewOrdersActivity.class);
                startActivity(intent);
            }
        });
