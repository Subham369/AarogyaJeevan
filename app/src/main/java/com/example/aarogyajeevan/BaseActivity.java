...
import com.example.aarogyajeevan.Model.CurrentUserSettings;
...
public abstract class BaseActivity extends AppCompatActivity {
    private DatabaseReference reference,rootref,ref;
    public String doctorUid,patientEmailId,position;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String patientUId=getIntent().getStringExtra("patientId");
...
//        reference= FirebaseDatabase.getInstance().getReference("Patient").child(patientUId);
...
//        doctorUid=firebaseUser.getUid();
//
//        ref= FirebaseDatabase.getInstance().getReference("Doctor").child(doctorUid);
//        rootref=FirebaseDatabase.getInstance().getReference();
//
