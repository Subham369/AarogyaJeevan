...
public class Delhi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(Delhi.this));
        ...
        mUpload=new ArrayList<>();
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    mAdapter = new PassPermissionAdapter(Delhi.this, mUpload);
                    mRecyclerView.setAdapter(mAdapter);
                }

                @Override
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(Delhi.this, "Error:" + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
