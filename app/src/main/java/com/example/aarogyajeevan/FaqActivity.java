...
import com.example.aarogyajeevan.Adapter.ChatAdapter;
import com.example.aarogyajeevan.Model.Message;
...
//        String customFont = "lato_bolditalic.ttf";
...
//        inputMessage.setTypeface(typeface);
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            listening = true;
            Toast.makeText(FaqActivity.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(FaqActivity.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    //Private com.example.aarogyajeevan.Methods - Speech to Text
    ...
    //Watson Speech to Text com.example.aarogyajeevan.Methods.
