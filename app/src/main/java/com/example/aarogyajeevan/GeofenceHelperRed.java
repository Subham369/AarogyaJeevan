...
public class GeofenceHelperRed extends ContextWrapper {

    private static final String TAG="GeofenceHelper";
    PendingIntent pendingIntent;
    public GeofenceHelperRed(Context base) {
        super(base);
    }
    ...
    public PendingIntent getPendingIntent(){
        ...
        Intent intent=new Intent(this,GeofenceBroadcastReceiverRed.class);
        pendingIntent=PendingIntent.getBroadcast(this,2609,intent,PendingIntent.FLAG_UPDATE_CURRENT);
        return pendingIntent;
    }
