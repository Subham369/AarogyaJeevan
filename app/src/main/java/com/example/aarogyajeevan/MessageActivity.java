...
import com.example.aarogyajeevan.Adapter.MessageAdapter;
import com.example.aarogyajeevan.Model.Chat;
import com.example.aarogyajeevan.Notifications.Client;
import com.example.aarogyajeevan.Notifications.Data;
import com.example.aarogyajeevan.Notifications.MyResponse;
import com.example.aarogyajeevan.Notifications.Sender;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MessageActivity.this,ChattingActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                readMessage(fuser.getUid(),userid,user.getImageURLW());
            }
    ...
    private void sendMessage(String sender, final String receiver, String message){
        ...
        reference=FirebaseDatabase.getInstance().getReference("UserInfo").child(fuser.getUid());
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                UserInfo user=dataSnapshot.getValue(UserInfo.class);
