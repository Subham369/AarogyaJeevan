...
public class Odisha extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(Odisha.this));
        ...
        mUpload=new ArrayList<>();
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    mAdapter = new PassPermissionAdapter(Odisha.this, mUpload);
                    mRecyclerView.setAdapter(mAdapter);
                }

                @Override
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(Odisha.this, "Error:" + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
