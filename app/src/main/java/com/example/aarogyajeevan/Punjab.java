...
public class Punjab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(Punjab.this));
        ...
        mUpload=new ArrayList<>();
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    mAdapter = new PassPermissionAdapter(Punjab.this, mUpload);
                    mRecyclerView.setAdapter(mAdapter);
                }

                @Override
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(Punjab.this, "Error:" + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
