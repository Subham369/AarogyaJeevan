...
import com.example.aarogyajeevan.Adapter.ListTaskAdapter;
import com.example.aarogyajeevan.Adapter.NoScrollListView;
    ...
    public void loadListView(NoScrollListView listView, final ArrayList<HashMap<String, String>> dataList) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(TodoListActivity.this, AddModifyTask.class);
