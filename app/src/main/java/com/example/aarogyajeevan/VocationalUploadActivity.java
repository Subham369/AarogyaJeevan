...
public class VocationalUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vocational_upload);
    ...
    public void ShowVideo(View view) {
        startActivity(new Intent(VocationalUploadActivity.this, VocationalVideoActivity.class));
    }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(VocationalUploadActivity.this, "Data saved", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(VocationalUploadActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
