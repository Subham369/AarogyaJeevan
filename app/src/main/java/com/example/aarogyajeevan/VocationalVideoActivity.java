...
import com.example.aarogyajeevan.ViewHolderCollection.ViewHolder;
...
public class VocationalVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vocational_video);
        ...
        FirebaseRecyclerAdapter<Member, ViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Member, ViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ViewHolder holder, final int position, @NonNull Member model) {
                        ...
                        holder.setExoplayer(getApplication(), "Sample Name", model.getVideourl());
                        ...
                        holder.setOnClicklistener(new ViewHolder.Clicklistener() {
                            ...
                            public void onItemClick(View view, int position) {
                                name = getItem(position).getVideoName();
                                url = getItem(position).getVideourl();
                                Intent intent = new Intent(VocationalVideoActivity.this,Fullscreen.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Member, ViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Member, ViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull ViewHolder holder, final int position, @NonNull Member member) {

                        holder.setExoplayer(getApplication(), member.getVideoName(), member.getVideourl());
    ...
    private void showDeleteDialog(final String name) {
        AlertDialog.Builder builder = new AlertDialog.Builder(VocationalVideoActivity.this);
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(VocationalVideoActivity.this, "Video Deleted", Toast.LENGTH_SHORT).show();
                    }
